...
const uploadRad = multer({ storage: storageRad, limits: { fileSize: 1024 * 1024 * 25 } }); // Límite de 25MB para imágenes
...
const pool = new Pool({
    connectionString: process.env.DATABASE_URL, // <-- Esta es la línea mágica
    ssl: {
